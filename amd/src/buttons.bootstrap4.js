...
(function( factory ){
	if ( typeof define === 'function' && define.amd ) {
		// AMD
		define( ['jquery', 'report_dashboard/dataTables.bootstrap4', 'report_dashboard/dataTables.buttons'], function ( $ ) {
		...
		var cjsRequires = function (root, $) {
			if ( ! $.fn.dataTable ) {
				require('report_dashboard/dataTables.bootstrap4')(root, $);
			}

			if ( ! $.fn.dataTable.Buttons ) {
				require('report_dashboard/dataTables.buttons')(root, $);
			}
		};
