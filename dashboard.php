...
/**
 * AJAX endpoint that returns the dashboard table HTML.
 *
 * Called asynchronously by dashboard.js to load the data table
 * after the page shell has been rendered by index.php.
 *
...
// Render the dashboard table using the template.
