...
$string['earlyengagementstatus_viewed'] = 'Viewed';
$string['fontsize'] = 'Text size';
$string['fontsize_11'] = 'Compact';
$string['fontsize_12'] = 'Small';
$string['fontsize_13'] = 'Medium';
$string['fontsize_14'] = 'Default';
$string['fontsize_16'] = 'Large';
